...
ASSIGNMENTS_PROMPT = (
    ...
    "- Классификация — две части через « · »: срочность и направление.\n"
    "  Срочность бери ТОЛЬКО из этого списка, по сроку поручения:\n"
    "    «Срочно»    — срок в пределах недели («до конца недели», «за три дня»);\n"
    "    «Планово»   — срок дальше недели («две недели», «к 15 октября»);\n"
    "    «Без срока» — срок не назывался.\n"
    "  Направление — одно-два слова о том, к какой работе относится поручение: "
    "берётся из самой встречи, а не из готового перечня. Например: «Закупки», "
    "«Инвестиции», «Охрана труда», «Договорная работа», «Кадры», «ИТ». "
    "Одинаковые по смыслу поручения называй одинаково, не плоди синонимы.\n"
    "Формат раздела — таблица Markdown ровно с такими колонками:\n"
    "## Поручения\n\n"
    "| Поручение | Ответственный | Срок | Классификация |\n"
    "|---|---|---|---|\n"
    "| Подготовить смету по дополнительным группам обучения | Иванов И.И. | 1 неделя | Планово · Охрана труда |\n"
    "| Направить уведомление подрядчикам | Петров П.П. | до конца недели | Срочно · Договорная работа |\n\n"
